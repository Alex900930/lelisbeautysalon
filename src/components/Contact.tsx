...
export default function Contact() {
  ...
  return (
    <section id="agendar" className="py-20 px-4 md:px-8 bg-[#2C1810] text-white">
        ...
        >
          ...
          >
            <input
              type="text"
              placeholder="Nome"
              className="w-full p-3 rounded-lg bg-white/10 border border-white/20 focus:border-[#D4AF37] transition-colors text-white"
          ...
          <motion.button
            type="submit"
            className="md:col-span-2 bg-[#D4AF37] text-white px-8 py-3 rounded-full text-lg hover:bg-[#B4941F] transition-colors mx-auto"
